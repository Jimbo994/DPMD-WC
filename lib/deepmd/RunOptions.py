...
if "-DHIGH_PREC" == "-DHIGH_PREC" :
    ...
    global_cvt_2_tf_float = tf.to_double
    global_cvt_2_ener_float = tf.to_double
    global_float_prec = 'double'
else :
    global_tf_float_precision = tf.float32
    global_np_float_precision = np.float32
    global_ener_float_precision = np.float64
    global_cvt_2_tf_float = tf.to_float
    global_cvt_2_ener_float = tf.to_double
    global_float_prec = 'float'

global_install_prefix='/home/arjun/jim/packages/deepmd-gpu/deepmd-kit3'
global_git_summ='v0.12.4-4-gdf917f6-dirty'
global_git_hash='df917f6'
global_git_date='2019-03-02 14:11:53 +0800'
global_git_branch='master'
global_tf_include_dir='/home/arjun/jim/packages/deepmd-gpu/tensorflow_gpu/include'
global_tf_libs='/home/arjun/jim/packages/deepmd-gpu/tensorflow_gpu/lib/libtensorflow_cc.so;/home/arjun/jim/packages/deepmd-gpu/tensorflow_gpu/lib/libtensorflow_framework.so'
